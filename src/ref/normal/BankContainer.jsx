...
//   const moneys = [50000, 10000, 5000, 1000, 500, 100, 50, 10];
//   const inputRef = useRef()
//   const [value, setValue] = useState([])

//   const handleButtonOnClick = () => {
//     let money = parseInt(inputRef.current.value)
//     const change = []


//     for (const unit of moneys) {
//       const count = Math.floor(money/unit)
//       if(count > 0) {
//         change.push({unit, count});
//         money %= unit;
//       }
//     }
...
//       <button onClick={handleButtonOnClick}>동전 거스르기!</button>
//       <>{result}</>
//     </div>
//   );
// };
